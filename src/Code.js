...
//    helles : new Beer('Helles', form.hellesSixth, form.hellesHalf, form.hellesCase),
    hefe : new Beer('Hoback Hefeweisen', form.hefeSixth, form.hefeHalf, form.hefeCase),    
    pakos : new Beer('Pako\'s IPA', form.pakosSixth, form.pakosHalf, form.pakosCase),
    snowKing : new Beer('Snow King Pale Ale', form.snowKingSixth, form.snowKingHalf, form.snowKingCase),
//    pakitos : new Beer('Pakito\'s Session IPA', form.pakitosSixth, form.pakitosHalf, form.pakitosCase),
